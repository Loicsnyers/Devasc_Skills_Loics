...
access_token = "YjNmNTBiZGItOTEzZS00ODY0LWJhNGUtODAxMTEzYTU5ZDY5ZTliMjU0ODctNWQy_P0A1_71b6b34c-abff-4407-ac50-5e62323aed80"

groups_struc = {
 "groups": [
      { "group": { "group_id": "G1" , "group_name": "devasc_skills_Loic_Snyers" ,    
                   "members": [   
                     {"person_id": "P-1" , "person_name": "Loic", "email": "loic.snyers@student.odisee.be"},
